...
alias py='python3.7'
alias pp='pip3'
alias venv-create='python3.7 -m venv ./venv'
alias act='source venv/bin/activate'

# git stuff 
alias git-dm='git push && git checkout master && git merge develop && git push && git checkout develop'
alias ignore='cp ~/personal/config/.gitignore .'
alias commit="git commit -v -t <(git rev-parse --abbrev-ref HEAD | grep --color=never -o 'CRAB-[0-9]\+') $*"

# code and explorer
alias coep='code . && explorer.exe .'
...
eval 'ssh-add ~/.ssh/id_rsa.work > /dev/null'
eval "ssh-add ~/.ssh/id_rsa.personal > /dev/null"
eval "clear"
